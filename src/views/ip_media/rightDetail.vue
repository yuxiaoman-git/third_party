<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="is_white" label="黑白名单类型"> </el-table-column>
      ...
      <el-table-column prop="with_granted" label="转授权"> </el-table-column>
...
import searchComponent from "./components/filmRight/search-rightDetail";
...
export default {
  ...
  methods: {
    ...
    async propertyList() {
      ...
      const res = await this.$store.dispatch("property/detailsList", {
        ...params,
        ...this.searchForm,
      });
    ...
    async handleEdit(row) {
      ...
      const res = await this.$store.dispatch("property/draftCopyright_detail", {
        id: row.id,
      });
      if (res.code === 0) {
    ...
    async getRightForm(data) {
      ...
      const res = await this.$store.dispatch("property/draftDetailsUpdate", {
        ...body,
      });
      if (res.code === 0) {
